...
if __name__ == "__main__":
    ...
    parser.add_argument("-l", "--log_transform", type=bool, default=False, help="If True, transform data to log(1+data)")
    parser.add_argument("-ll", "--double_log_transform", type=bool, default=False, help="If True, transform data to log(log(1+data))")
    parser.add_argument("-s", "--std", type=bool, default=False, help="If True, transform data to ((data - mean) / max) * 0.95")
    parser.add_argument("-m", "--med", type=bool, default=False, help="If True, transform data to ((data - med) / max) * 0.95")
